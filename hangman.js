const channelID = '870769102858362900'
const createChannelID = '871126187836051548'
...
module.exports = async (client) => {
    let createChannel = client.guilds.cache.get('853033157313822721').channels.cache.get(createChannelID)
    ...
    client.on('message', async (message) => {
        ...
        if (channel.id === channelID) {
            ...
            if (command[0].toLowerCase() === `${prefix}letter`) {
                ...
                if (hangmanGame(channel, word, command[1]) === 'game over') {
                    currentGame = false
                }
            }
